@extends('dashboards.homes.layouts.home-dash-layout')
              ...
              {{-- <a href="#" class="btn btn-danger" id="deleteAllSelectedRecord">Delete Selected</a> --}}
                ...
                {{-- <button class="btn btn-danger" id="multi-delete" data-route="{{ route('posts.multi-delete') }}">Delete All Selected</button> --}}
                  ...
                  <tbody>
                         ...
                         <td>
                            <img src="{{asset('homeimg/'.$item->websitelogo)}}" width="200px" alt="" srcset="">
                        </td>
                        <td>
                          <img src="{{asset('homeimg/'.$item->websiteimage)}}" width="200px" alt="" srcset="">
                      </td>
