      ...
      <div class="container-fluid">
        ...
        <div class=" card card-info card-outline">
            <div class="card-header">
                ...
                {{-- <a href="{{ route('createcontactcard1') }}" class="btn btn-success  mt-2 mb-3 ">Tambah <i class="fas fa-plus-square"></i></a> --}}
                ...
                <h2>Card 2</h2>
                {{-- <a href="{{ route('createcontactcard2') }}" class="btn btn-success  mt-2 mb-3 ">Tambah <i class="fas fa-plus-square"></i></a> --}}
